  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year custom-select light-select select-year form-control' name='birth[year]'></select>"),
          $month = $("<select class='birth-month custom-select light-select select-month form-control' name='birth[month]'></select>"),
          $day = $("<select class='birth-day custom-select light-select select-date form-control' name='birth[day]'></select>");
