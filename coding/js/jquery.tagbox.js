...
//  Hide Element
  ...
  //  Generate Tags List from Input item
      ...
      if(!options.readonly) {
		...
		jQuery('body').delegate('.'+options.className+'-remove-'+uuid, "click", function(){
			//console.log('.'+options.className+'-remove-'+uuid);
