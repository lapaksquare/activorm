  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year custom-select light-select select-year' name='birth[year]'></select>"),
          $month = $("<select class='birth-month custom-select light-select select-month' name='birth[month]'></select>"),
          $day = $("<select class='birth-day custom-select light-select select-date' name='birth[day]'></select>");
