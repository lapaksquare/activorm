...
class S_account_model extends CI_Model{
	
	function getSalesAccess($email, $password){
		$sql = "
         SELECT
            ma.account_id,
            ma.account_name,
            ...
            srr.role_id,
            srr.access_list,
            srr.access_list_detail
         FROM
            member__account ma 
            JOIN sales__rel_role srr ON
               ma.account_id = srr.account_id
         WHERE 1
