			...
			<div class="row">
				<div id="content" class="col-md-9">
					...
					<div class="box entry">
						...
						<div class="entry-footer">
							<ul class="clearfix list-unstyled entry-share">
								<li class="share-facebook" data-url="http://yahoo.com" data-text="Sharing text goes here" data-title="share"></li>
								<li class="share-twitter" data-url="http://yahoo.com" data-text="Sharing text goes here" data-title="tweet"></li>
								<li class="share-googleplus" data-url="http://yahoo.com" data-text="Sharing text goes here" data-title="+1"></li>
								<li class="share-comments sharrre">
									<div class="box">
										<a class="count" href="#">999</a>
										<a class="share" href="#">comments</a>
