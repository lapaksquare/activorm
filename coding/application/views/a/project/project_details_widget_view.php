	...
	<div class="widget">
		...
		<div class="widget-body">
			...
			?>
									...
									<div class="widget-auth" >
										<div class="widget-auth-sp">More Tickets (max. 3 tickets). Please check <a href="<?php echo base_url(); ?>project/<?php echo $this->project->project_uri; ?>" target="_blank">here</a>.</div>
									</div>	
