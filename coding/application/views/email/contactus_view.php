								...
								<tr>
									<td style="border-collapse: collapse;">
										<div class="content" style="margin: 0 -40px;padding: 10px 40px 100px;background: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
											<h1 class="content-title" style="margin: 0 0 20px;padding: 0 0 10px;font-size: 24px;border-bottom: 1px solid #e8e8e8;color: #555555;">Contact Us</h1>
											<p style="margin: 1em 0;">
												<b>Contact Name </b> : <?php echo $contact_name; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Contact Email </b> : <?php echo $contact_email; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Contact Company </b> : <?php echo $contact_company; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Contact Phone </b> : <?php echo $contact_phone; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Contact Subject </b> : <?php echo $contact_subject; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Contact Message </b> : <?php echo $contact_message; ?>
											</p>
										</div>
									</td>
								</tr>
