								...
								<tr>
									<td style="border-collapse: collapse;">
										<div class="content" style="margin: 0 -40px;padding: 10px 40px 100px;background: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
											<h1 class="content-title" style="margin: 0 0 20px;padding: 0 0 10px;font-size: 24px;border-bottom: 1px solid #e8e8e8;color: #555555;">Report Bug</h1>
											<p style="margin: 1em 0;">
												<b>Name </b> : <?php echo $name; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Bug Type </b> : <?php echo $bug_type; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Bug Url </b> : <?php echo $bug_url; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Bug Message </b> : <?php echo $bug_message; ?>
											</p>
											<p style="margin: 1em 0;">
												<b>Account Email </b> : <?php echo $account_email; ?>
											</p>
										</div>
									</td>
								</tr>
