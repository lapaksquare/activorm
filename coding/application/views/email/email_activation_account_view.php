								...
								<tr>
									<td style="border-collapse: collapse;">
										<div class="content" style="margin: 0 -40px;padding: 10px 40px 100px;background: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
											...
											<p style="margin: 1em 0;text-align:center;">Verification Code : <br /><b style="font-size:28px;"><?php echo $verification_code; ?></b></p>
											<p class="signup" style="margin: 1em 0;text-align:center;"><a class="button" href="<?php echo base_url(); ?>auth/vcautoauth?vc=<?php echo $verification_code; ?>&vch=<?php echo sha1(SALT . $verification_code); ?>" style="padding: 10px 30px;text-align:center;display: inline-block;color: #fff;font-size: 18px;font-weight: bold;text-decoration: none;background: #20b396;border-bottom: 2px solid #1fa88c;border-radius: 5px;">Go to Activorm</a></p><br />
