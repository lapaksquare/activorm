								...
								<tr>
									<td style="border-collapse: collapse;">
										<div class="content" style="margin: 0 -40px;padding: 10px 40px 100px;background: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
											<h1 class="content-title" style="margin: 0 0 20px;padding: 0 0 10px;font-size: 24px;border-bottom: 1px solid #e8e8e8;color: #555555;">Reset Your Password</h1>
											<p style="margin: 1em 0;"><strong>Hi <?php echo $account_name; ?>!</strong></p>
											<p style="margin: 1em 0;">To reset your password please follow the button below:
<br />
<a href="<?php echo $link_reset_password; ?>" class="button" style="padding: 5px 15px;display: inline-block;color: #fff;font-size: 13px;margin:8px 0;font-weight: bold;text-decoration: none;background: #20b396;border-bottom: 2px solid #1fa88c;border-radius: 5px;">Change Password</a>
<br />
If you find any problems during signing up, please contact our support at <strong><a href="mailto:info@activorm.com" style="color: #20b396;text-decoration: none;">info@activorm.com</a></strong></p>
										</div>
									</td>
								</tr>
							</table>
