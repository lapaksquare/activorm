...
<body style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #4c4c4d;font-size: 16px;font-family: 'Myriad Pro', Arial, Helvetica, sans-serif;line-height: 1.6;background: #ecf0ef;width: 100%;">
								...
								<tr>
									<td style="border-collapse: collapse;">
										<div class="content" style="margin: 0 -40px;padding: 10px 40px 100px;background: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
											...
											<p style="margin: 1em 0;"><strong>Hi Karen!</strong></p>
											...
											<p style="margin: 1em 0;">www.activiom.com/aksjkaskasjksa</p>
											<p style="margin: 1em 0;">Thank you for registering on Activorm. If you find any problems during signing up, please contact our support at <strong><a href="#" style="color: #20b396;text-decoration: none;">info@activorm.com</a></strong></p>
											<p style="margin: 1em 0;">P.S If the activation code above doesn't work, please visit the following link to verify your email address</p>
											<p style="margin: 1em 0;"><a href="#" style="color: #20b396;">www.activiom.com/aksjkaskasjksa</a></p>
										</div>
									</td>
								</tr>
							</table>
